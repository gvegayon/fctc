...
$(function(){
    // $('.secondary ul ul').hide();

    // $("li:has(ul)").click(function(){
      // $(this).parent().find('li.active').not(this).toggleClass('active').find('ul').slideToggle();
    ...
    $("li:has(ul)").click(function(){
      $(this).parent().find('li.active').not(this).toggleClass('active')
    });
...
$(document).ready(function() {
  ...
  equalHeight($(".equal-paragraph"));
  equalHeight($(".equal-newlist-item"));
  equalHeight($(".group1 .news-list div"));

  equalHeight($("#viral1 .eq-header"));
  equalHeight($("#viral2 .eq-header"));
  equalHeight($("#viral3 .eq-header"));
  equalHeight($("#viral1 .eq-paragraph"));
  equalHeight($("#viral2 .eq-paragraph"));
  equalHeight($("#viral3 .eq-paragraph"));
  equalHeight($("#viral1 .eq-newlist-item"));
  equalHeight($("#viral2 .eq-newlist-item"));
  equalHeight($("#viral3 .eq-newlist-item"));
...
$(document).ready(function(){
  ...
  // Galleria.loadTheme('stylesheets/vendor/gallery/galleria.classic.js');
