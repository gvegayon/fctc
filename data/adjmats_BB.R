# This script creates the adjacency matrices that will be used in Brooke's analysis
...
networks_to_use <- c(
  ...
  "Distance (static)", "Referrals", "GL Posts",
  "Interest Group co-membership (two-mode)", "Phone", "Colonial Linkage (static)",
  "CAC INB", "COP Corrupt II (two-mode)", "Pollute INC (two-mode)",
  "Pollut COP", "Bank of International Settlements", "Bilateral Aid Flow",
  "IMF assetts"
)
...
# Keeping diffnets
save.image(file = 'data/adjmats_BB.rda')
